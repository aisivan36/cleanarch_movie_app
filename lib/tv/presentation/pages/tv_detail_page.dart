...
class _TvDetailContentState extends State<TvDetailContent>
  ...
  @override
  Widget build(BuildContext context) {
    // print('Jajal iki ${_showEpisodeDuration(widget.tv.episodeRunTime)}');
    if (kDebugMode) print('Jajal iki ${widget.tv?.episodeRunTime}');
    if (kDebugMode) print('status iki ${widget.tv?.status}');
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      // Have fixed it
                      Text(
                        _showEpisodeDuration() == '0m'
                            ? '' // If 0m then shows an empty String
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      /// Check wheter is already mounted
                      if (!mounted) return;
                      final message =
                          Provider.of<TvDetailNotifier>(context, listen: false)
                              .watchlistMessage;
  ...
  String? _showEpisodeDuration() {
    int runtime =
        widget.tv!.episodeRunTime.isNotEmpty ? widget.tv!.episodeRunTime[0] : 0;
